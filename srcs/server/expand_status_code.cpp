...
//append an explanation to http code
...
string expand_status_code(int code)
{
	switch (code) {
		...
		case 300: return ("300 Multpiple Choices");
		...
		case 500: return ("500 Expectation Failed");
	...
	cerr << "Unknown error code: "<< code << endl;
	return (itostring(code));
}
